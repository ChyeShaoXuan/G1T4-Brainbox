  ...
  let api_endpoint_url = "study.json"
    ...
    for (let i=0; i<default_data_arr.length;i++){
      ...
      `<div class='row mb-3 gap-0'>
          ...
          <div class='col-sm-12 col-md-12 col-lg-12 col-xl-12 mx-auto text-center rounded  ms-0 focus:scale-125' style='transition: transform .2s;background-image:url("../Images/gif_background.gif");background-size:cover;background-repeat: no-repeat;'>
