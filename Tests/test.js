...
function show_test(difficulty,subject){
    ...
    .then(response => {  
    // first block of code for english 
        if(subject=="english"){
            if(difficulty=="easy"){
        ...
        <div class="text-blue-900 ms-3 me-3 text-center text-xl font-bold">Test 1 - ${difficulty}</div>
         ...
         <div class="container text-center rounded bg-gradient-to-r from-blue-200 to-blue-300 my-5 text-red-900 font-semibold" 
         style="width: fit-content;"><button class=btn btn-primary' onclick='display_questions("medium","english")'>Start Test!</button></div>
         </div>`;
        content_section.innerHTML=new_html;
        ...
        <div class="text-blue-900 ms-3 me-3 text-center text-xl font-bold">Test 1 - ${difficulty}</div>
         ...
         <div class="container text-center rounded bg-gradient-to-r from-blue-200 to-blue-300 my-5 text-red-900 font-semibold" 
         style="width: fit-content;"><button class=btn btn-primary' onclick='display_questions("hard","english")'>Start Test!</button></div>
         </div>`;
        content_section.innerHTML=new_html;
    ...
    axios.get(api_endpoint_url)
    .then(response => {  
        // english subject, for different difficulties
        if(subject=="english"){
            if(difficulty=="easy"){
        ...
        let content_section=document.getElementById('content_section')
        let questions_arr=response.data.english.medium;
        console.log(questions_arr)
        let new_html=`<div id="carouselExampleCaptions" class="carousel slide md:ms-3 sm:mt-3">
    ...
    //hard difficulty
        ...
        let content_section=document.getElementById('content_section')
        let questions_arr=response.data.english.hard;
        console.log(questions_arr)
        let new_html=`<div id="carouselExampleCaptions" class="carousel slide md:ms-3 sm:mt-3">
